...
import { Resolver, Args, ArgsType, Mutation, ID, Field } from "type-graphql";
...
export class FileUploadResolver {
  ...
  async newFileUpload(
    @Args() { meId, filename, filetype }: NewFileUploadArgs
    ...
    if (returnObject) {
      let file = await ContentFile.createQueryBuilder("file")
        ...
        .andWhere("file.signedRequest = :signedRequest", {
